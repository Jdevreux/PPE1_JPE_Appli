...
// Chargement de table Patrice Grand

function LoadRequete($connexion,$req)
{
...
//Tableau coloré
// Patrice Grand
function FancyTableEnTete($header)
{
...
//
function FancyTableReq($req,$connexion)
{
		//Données
		$w=array(40,35,45,40);
	$fill=0;
